...
CREATE TABLE IF NOT EXISTS `bids` (
  ...
  `type` enum('fixed','hourly','monthly') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `module` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `notification_settings` (
  ...
  `notify_to_team_members` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
